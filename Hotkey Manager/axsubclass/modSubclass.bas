...
Sub AttachMessage(iwp As clsISubclass, ByVal hwnd As Long, _
                  ByVal iMsg As Long)
...
Sub DetachMessage(iwp As clsISubclass, ByVal hwnd As Long, _
                  ByVal iMsg As Long)
    Dim procOld As Long, f As Long, c As Long
...
Private Function WindowProc(ByVal hwnd As Long, ByVal iMsg As Long, _
    ...
    Dim iwp As clsISubclass, iwpT As clsISubclass
