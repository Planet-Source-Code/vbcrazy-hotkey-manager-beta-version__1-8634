VERSION 5.00
Begin VB.UserControl AxImageListCtl 
   ClientHeight    =   915
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   1020
   ...
   PropertyPages   =   "AxImageList.ctx":0000
   ScaleHeight     =   915
   ScaleWidth      =   1020
   ToolboxBitmap   =   "AxImageList.ctx":001D
   Begin VB.PictureBox picImage 
      AutoRedraw      =   -1  'True
      Height          =   555
      Left            =   420
      Picture         =   "AxImageList.ctx":0117
      ScaleHeight     =   495
      ScaleWidth      =   495
      TabIndex        =   0
      Top             =   300
   ...
   End
End
Attribute VB_Name = "AxImageListCtl"
